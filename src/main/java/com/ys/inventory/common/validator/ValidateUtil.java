...
public class ValidateUtil {
    ...
    //中国移动号段正则表达式
    private static final String CHINA_MOBILE_PHONE_NUMBER_REGEX = "^((13[4-9])|(15([0-2]|[7-9]))|(18[2|3|4|7|8])|(178)|(147))[\\d]{8}$";

    //中国联通号段正则表达式
    private static final String CHINA_UNICOM_PHONE_NUMBER_REGEX = "^((13[0-2])|(145)|(15[5-6])|(176)|(18[5-6]))[\\d]{8}$";

    //中国电信号段正则表达式
    private static final String CHINA_TELECOM_PHONE_NUMBER_REGEX = "^((133)|(153)|(18[0|1|9])|(177))[\\d]{8}$";

    //Email正则表达式
    private static final String EMAIL_REGEX = "^([a-zA-Z0-9]+[_|\\_|\\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\\_|\\.]?)*[a-zA-Z0-9]+\\.[a-zA-Z]{2,3}$";
    ...
    public static boolean isPhone(String str){
        if(str == null){
            return false;
        }else if(str.matches(CHINA_MOBILE_PHONE_NUMBER_REGEX)){
            return true;
        }else if(str.matches(CHINA_UNICOM_PHONE_NUMBER_REGEX)){
            return true;
        }else if(str.matches(CHINA_TELECOM_PHONE_NUMBER_REGEX)){
            return true;
        }else{
            return false;
        }
